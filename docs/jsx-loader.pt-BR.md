...
<p align="center">Um minúsculo (6.9 kB) e ultra rápido compilador baseado em navagador para JSX / React.</p>
<hr>
...
O script `jsxLoader.js` é muito pequeno para baixar (6.9 kB - min e em gzip) e compila código muito rapidamente (geralmente em milisegundos para cada script JSX).
