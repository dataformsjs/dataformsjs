...
* **O Framework DataFormsJS – 10.8 kB** (149 kB da versão completa e descompactada)
...
* **React JSX Loader – 5.7 kB** (85 kB da versão completa e descompactada)
* **React (Todos so componentes em JavaScript) – 5.1 kB**
