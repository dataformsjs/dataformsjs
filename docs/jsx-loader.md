...
<p align="center">An ultra-fast and tiny (6.9 kB) browser based compiler for JSX / React.</p>
<hr>
...
The `jsxLoader.js` script is very small to download (6.9 kB - min and gzip) and compiles code very fast (often in milliseconds for each JSX script).
