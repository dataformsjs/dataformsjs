...
-->
<script src="https://cdn.jsdelivr.net/npm/dataformsjs@5.3.1/js/react/jsxLoader.min.js"></script>

<!--
    Include JSX components and scripts using [type="text/babel"].
    This is the same method that would be used with Babel Standalone.
-->
<script type="text/babel" src="https://cdn.jsdelivr.net/npm/dataformsjs@5.3.1/js/react/es6/JsonData.js"></script>
